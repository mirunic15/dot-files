...
local function worker(user_args)
    ...
    local font = args.font or 'Charybdis 13'
    local path_to_icons = args.path_to_icons or HOME .. "/.config/awesome/themes/my-first-rice-UWU/battery-widget/symbolic/"
    local show_current_level = args.show_current_level or true
    local margin_left = args.margin_left or 10
    local margin_right = args.margin_right or 8
    ...
    local warning_msg_title = args.warning_msg_title or 'Oh no! >//<'
    local warning_msg_text = args.warning_msg_text or 'Battery is dying'
    local warning_msg_position = args.warning_msg_position or 'bottom_left'
    ...
    function(widget, stdout)
        ...
        icon_widget.margin.icon:set_image(path_to_icons .. batteryType .. ".svg")
