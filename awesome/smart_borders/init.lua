...
local function new(config)
    local cfg = config or {}
    local positions = cfg.positions or { "right", "bottom"}
    ...
    local color_normal = cfg.color_normal or "#191613"
    local color_focus = cfg.color_focus or "#191613"
    ...
    local button_left_click = cfg.button_left_click or function(c)
        if c.maximized then             c.maximized = false
        end
